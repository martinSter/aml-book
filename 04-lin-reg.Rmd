...
```{r simple-reg, echo=FALSE, fig.show = 'hold', fig.cap='Einfaches Regressionsbeispiel.', out.width='70%', fig.asp=1, fig.align='center', fig.alt='Einfaches Regressionsbeispiel.'}
library(latex2exp)
# Data points
x <- c(-4.1, -0.5, 1.4, 4.4)
...
```{r simple-reg-cost, echo=FALSE, fig.show = 'hold', fig.cap='Einfaches Regressionsbeispiel. Das geschätzte Modell ist als blaue Gerade eingezeichnet. Die vertikalen roten Linien stellen die Abweichungen der wahren Outputs von den Vorhersagen dar.', out.width='50%', fig.asp=1, fig.align='center', fig.alt='Einfaches Regressionsbeispiel.'}
library(latex2exp)
# Data points
x <- c(-4.1, -0.5, 1.4, 4.4)
y <- c(3.5, 1.95, -2.5, -2.05)
