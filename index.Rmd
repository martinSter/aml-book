...
```{r kimldl, echo = FALSE, fig.cap = 'Unterscheidung zwischen KI, ML und DL. ', out.width='60%', fig.align='center'}
knitr::include_graphics("images/KI_ML_DL.png")
```
...
```{r genAIExML, echo = FALSE, fig.cap = 'Beispielsoutput einer generativen Bildgenerierungssoftware (https://stablediffusionweb.com/) basierend auf dem Prompt "A title image for a textbook about Machine Learning targeting small and medium companies."', out.width='70%', fig.align='center'}
knitr::include_graphics("images/title_picture_ML.png")
```
